    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(default=oauth2app.oauth2app.models.KeyGenerator(), unique=True, max_length=30, db_index=True)),
                ('secret', models.CharField(default=oauth2app.oauth2app.models.KeyGenerator(), unique=True, max_length=30)),
